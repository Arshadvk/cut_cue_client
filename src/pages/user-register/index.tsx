  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(/assets/images/background/login/register.webp)",
        }}
      >
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-start p-12 bg-white">
        <h1 className="text-2xl font-bold ">Register into Cut Cue</h1>
        ...
        <div className="flex items-center justify-center" style={{textAlign:"center"}}>
          <p className="text-center text-gray-500">
            ...
            <Link className="text-black font-bold" href="/user-login">
              Sign In
            </Link>
          </p>
        </div>
