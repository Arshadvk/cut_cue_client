...
export default function GlassCard({}:any) {
    return (
        ...
        <div className="grid  md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-5 items-center justify-center bg-white gap-5">
            
            <div className="relative w-[300px] h-[280px] rounded-[30px] overflow-hidden shadow-2xl bg-white/10 backdrop-blur-lg border border-white/20 flex flex-col justify-end p-5">
                {/* Background Image */}
                <div
            ...
            <div className="relative w-[300px] h-[280px] rounded-[30px] overflow-hidden shadow-2xl bg-white/10 backdrop-blur-lg border border-white/20 flex flex-col justify-end p-5">
             ...
             <div className="relative w-[300px] h-[280px] rounded-[30px] overflow-hidden shadow-2xl bg-white/10 backdrop-blur-lg border border-white/20 flex flex-col justify-end p-5">
                ...
                <div
                    className="absolute inset-0 bg-cover bg-center"
                    style={{
                        backgroundImage: "url('/assets/images/card/card-3.avif')", // replace with your image path
                    }}
                    ></div>
